        ...
        <div className="">
          ...
          <div className="space-y-3.5">
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 text-[#2FB3A3] bg-gradient-to-br from-teal/20 to-blue/10">
                <Phone size={17} strokeWidth={2.2} />
              </div>
              <span className="text-[14px] font-semibold text-ink2">Trisna: +62 823-4272-0379</span>
            </div>
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 text-p1 bg-gradient-to-br from-p1/20 to-blue/10">
                <Phone size={17} strokeWidth={2.2} />
              </div>
              <span className="text-[14px] font-semibold text-ink2">Nia: +62 877-4503-2833</span>
            </div>
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 text-blue bg-gradient-to-br from-blue/20 to-p1/10">
                <Globe size={17} strokeWidth={2.2} />
              </div>
              <span className="text-[14px] font-semibold text-ink2">konten.ai</span>
            </div>
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 text-[#E0932B] bg-gradient-to-br from-[#FFB347]/20 to-rose/10">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input required type="text" placeholder="Coffee Shop / Fashion Brand" value={form.business} onChange={(e) => setForm({...form, business: e.target.value})} className="finput w-full p-[12px_16px] font-sans text-[14px] bg-white/55 border-[1.5px] border-white/70 rounded-xl outline-none focus:border-p1 focus:bg-white/80 transition-all" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                ...
                <div>
                  ...
                  <select value={form.businessType} onChange={(e) => setForm({...form, businessType: e.target.value})} className="fselect w-full p-[12px_16px] font-sans text-[14px] bg-white/55 border-[1.5px] border-white/70 rounded-xl outline-none focus:border-p1 focus:bg-white/80 transition-all cursor-pointer">
                    ...
                    <option>UMKM / Retail</option>
                    <option>Restaurant / Cafe</option>
                    <option>Service / Salon / Clinic</option>
                    <option>Startup / Brand Online</option>
              ...
              <div>
                ...
                <select value={form.plan} onChange={(e) => setForm({...form, plan: e.target.value})} className="fselect w-full p-[12px_16px] font-sans text-[14px] bg-white/55 border-[1.5px] border-white/70 rounded-xl outline-none focus:border-p1 focus:bg-white/80 transition-all cursor-pointer">
                  ...
                  <option>Not sure yet, just want to chat</option>
                </select>
              </div>
              <div>
