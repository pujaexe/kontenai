...
export default function Footer() {
  return (
    <footer
      className="py-12 px-6 md:px-[56px] border-t border-white/5 relative z-20"
      style={{ backgroundColor: 'rgba(10, 9, 22, 0.98)', color: 'white' }}
    >
      <div className="max-w-[1024px] mx-auto flex flex-col md:flex-row justify-between items-center">
      ...
      >
        ...
        We specialize in social media management and automation for SMEs, retail brands, restaurants, startups, hotels, and service businesses.
