...
export const HOW_STEPS = [
  { step: 'STEP 01', icon: '🔍', title: 'Research Agent', desc: 'Gathers intel on your business, competitors, and audience to build a solid content foundation.' },
  { step: 'STEP 02', icon: '📡', title: 'Trend Agent',    desc: 'Monitors real-time trends on Instagram, TikTok, and platforms relevant to your niche.' },
  { step: 'STEP 03', icon: '✍️', title: 'Content Agent',  desc: 'Writes captions, hashtags, and copy matching your brand voice — ready for your quick review.' },
  { step: 'STEP 04', icon: '🚀', title: 'Posting Agent',  desc: 'Schedules and publishes at optimal times across Instagram, TikTok, and Facebook.' },
]
...
export const MARQUEE_ITEMS = [
  'Social Media Automation', 'Lead Generation', 'Villa & Hotel Content',
